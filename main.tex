...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{At}{12}{\href{mailto:m88@stdwtr.io}{m88@stdwtr.io}}\\
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
	...
	\icon{Github}{12}{\href{https://github.com/malan88}{github.com/malan88}}\\
	\icon{StackOverflow}{12}{\href{https://twitter.com/@alyxvance}{@alyxvance}}\\
\end{minipage}
