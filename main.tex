...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
    ...
    \icon{Phone}{+1 (727) 272-3915}\\
    \icon{Envelope}{\href{mailto:m@stdwtr.io}{m@stdwtr.io}}\\
    \icon{Linkedin}{\href{https://linkedin.com/in/michael-sendker}{michael-sendker}}\\
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
    \vspace{-\baselineskip} % Required for vertically aligning minipages
    \icon{Globe}{\href{https://standingwater.io}{standingwater.io}}\\
    \icon{Globe}{\href{https://blog.standingwater.io}{blog.standingwater.io}}\\
    \icon{Github}{\href{https://github.com/malan88}{malan88}}\\
    \icon{StackOverflow}{\href{https://stackoverflow.com/story/malan88}{malan88}}\\
\end{minipage}
